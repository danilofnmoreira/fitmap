...
class SetRolesServiceTest {
    ...
    void an_TokenExpiredException_should_be_thown_if_the_IDToken_is_invalid() throws Exception {
        ...
        var request = new SetRolesRequest("idToken", UserType.GYM);

        assertThatThrownBy(() -> setRolesService.setRoles(request))
    ...
    @Test
    @DisplayName(value = "if roles has already setted, should throws RolesAlreadySettedException")
    void if_roles_has_already_setted_should_throws_RolesAlreadySettedException() throws Exception {
        ...
        assertThatThrownBy(() -> setRolesService.setRoles(request))
            .isInstanceOf(RolesAlreadySettedException.class)
    ...
    void should_set_successfuly_the_roles_when_IDToken_is_valid_and_there_are_not_roles() throws Exception {
        ...
        setRolesService.setRoles(request);
